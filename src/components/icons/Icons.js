...
//import { ReactComponent as OOSTLoge } from "./OOST_logo_sample.png";

export const OOSTrendLogo = createIcon({
  displayName: "OOSTrendLogo",
  viewBox: "0 0 179 20",
  path: ( 
    <g transform="matrix(1,0,0,1,-282.321,-396.307)">
        <path d="M453.826,412.806C447.516,415.605 440.734,417.496 433.617,418.347C440.882,413.992 446.461,407.097 449.088,398.88C442.289,402.913 434.759,405.84 426.743,407.418C420.326,400.58 411.181,396.307 401.06,396.307C381.629,396.307 365.874,412.061 365.874,431.493C365.874,434.25 366.185,436.936 366.785,439.511C337.542,438.044 311.615,424.036 294.26,402.747C291.232,407.944 289.496,413.988 289.496,420.436C289.496,432.644 295.708,443.414 305.149,449.724C299.382,449.541 293.956,447.958 289.212,445.323C289.208,445.469 289.208,445.617 289.208,445.765C289.208,462.813 301.337,477.033 317.434,480.268C314.481,481.072 311.373,481.502 308.164,481.502C305.897,481.502 303.693,481.281 301.544,480.871C306.022,494.849 319.016,505.022 334.414,505.305C322.371,514.743 307.2,520.369 290.714,520.369C287.874,520.369 285.073,520.201 282.321,519.876C297.892,529.861 316.388,535.686 336.258,535.686C400.978,535.686 436.371,482.07 436.371,435.572C436.371,434.046 436.337,432.529 436.269,431.019C443.143,426.059 449.108,419.863 453.825,412.806L453.826,412.806Z"/>
    </g>
  ),
});

export const OOSTLogo = createIcon({
  displayName: "OOSTLogo",
  viewBox: "0 0 598.000000 253.000000",
  path: (
        <g transform="translate(0.000000,253.000000) scale(0.100000,-0.100000)" fill="#0000FF" stroke="none">
          <path d="M1869 1913 c-13 -17 -13 -17 6 -3 11 8 22 16 24 17 2 2 0 3 -6 3 -6 0 -17 -8 -24 -17z"/>
          <path d="M1936 1873 c-6 -14 -5 -15 5 -6 7 7 10 15 7 18 -3 3 -9 -2 -12 -12z"/>
          <path d="M1830 1850 c-6 -11 -8 -20 -6 -20 3 0 10 9 16 20 6 11 8 20 6 20 -3 0 -10 -9 -16 -20z"/>
          <path d="M1910 1830 c-6 -11 -8 -20 -6 -20 3 0 10 9 16 20 6 11 8 20 6 20 -3 0 -10 -9 -16 -20z"/>
          <path d="M2505 1836 c-94 -41 -136 -115 -143 -251 -8 -154 34 -247 132 -294 36 -18 61 -21 177 -21 151 0 189 11 246 70 54 55 66 101 61 237 -4 127 -13
          155 -65 207 -54 55 -94 66 -243 65 -89 0 -145 -4 -165 -13z m319 -107 c45 -35 56 -70 56 -169 0 -99 -11 -134 -56 -169 -24 -19 -40 -21 -146 -21 -181 0 -209 23 -216 175 -5 108 10 154 60 185 28 17 50 20 154 20 108 0 124 -2 148 -21z"/>
          <path d="M3282 1825 c-104 -53 -149 -174 -125 -339 14 -98 48 -151 122 -188 52 -26 62 -28 191 -28 136 0 136 0 190 33 42 25 61 44 82 86 26 49 28 62 28 170 0 108 -2 122 -27 172 -21 40 -40 61 -77 84 -48 29 -54 30 -190 33 -136 3 -143 2 -194 -23z m349 -114 l39 -39 0 -112 0 -112 -39 -39 -39 -39 -122 0
          ...
          13z"/>
          <path d="M4890 700 c0 -5 5 -10 11 -10 5 0 7 5 4 10 -3 6 -8 10 -11 10 -2 0 -4 -4 -4 -10z"/>
          <path d="M5030 700 c0 -5 5 -10 10 -10 6 0 10 5 10 10 0 6 -4 10 -10 10 -5 0 -10 -4 -10 -10z"/>
          <path d="M663 654 c-7 -20 19 -47 38 -39 8 3 21 15 28 28 13 22 13 22 -12 -2 -28 -25 -52 -20 -44 10 6 23 -1 25 -10 3z"/>
          </g>
  ),
});

export const NaverLogo = createIcon({
  displayName: "NaverLogo",
  viewBox:'0 0 521.0783691 100',
  path: ( 
    <g width='521.0783691' height='100'  fill='none' xmlns="http://www.w3.org/2000/svg">
...
export const CoupangLogo = createIcon({
  displayName: "CoupangLogo",
  viewBox : "0 0 763.000000 172.000000",
  path: (
    <g width="763.000000" height="172.000000" transform="translate(0.000000,172.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none" xmlns="http://www.w3.org/2000/svg"> 
